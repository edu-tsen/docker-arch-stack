...
cp localepurge $ROOTFS/usr/local/bin/localepurge
chmod +x $ROOTFS/usr/local/bin/localepurge
cp locale.nopurge $ROOTFS/etc/locale.nopurge
arch-chroot $ROOTFS /bin/sh -c 'localepurge'
